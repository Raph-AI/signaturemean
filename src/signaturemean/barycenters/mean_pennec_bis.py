...
"""
            ...
            RETURN SOLUTION AT ITERATION MAX_ITER 

                            AND

            SOLUTIONS AT ITERATION 0, 1, ..., MAX_ITER - 1
...
def mean(datasig, depth, channels, max_iter=20, init='random', init_ts=None):
    """
    ...
    while n_iter < max_iter:
        ...
        n_iter += 1
        bary.append(sigbarycenter1)
    return(torch.from_numpy(sigbarycenter1[1:]), bary)  # omit scalar value
